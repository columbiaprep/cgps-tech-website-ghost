...
21:00,41,20
22:00,41,25
23:00,41,30`,data=d3.csvParse(csvData);function makeChart(e){let t=e.map(e=>e["Time (by hour)"]);t=t.map(e=>{var[t,n]=e.split(":");return"0:00"===e?"12:00 AM":(e=12<=t?"PM":"AM",(12<t?t-12:t)+`:${n} `+e)});var n=e.map(e=>e["Temp (F)"]),e=e.map(e=>e["Avg Wind Speed (mph)"]),o=document.getElementById("chart").getContext("2d");new Chart(o,{type:"line",data:{labels:t,datasets:[{label:"Temperature (F)",data:n,borderColor:"rgb(255, 99, 132)",fill:!1},{label:"Avg Wind Speed (mph)",data:e,borderColor:"rgb(75, 192, 192)",fill:!1}]},options:{responsive:!0,title:{display:!0,text:"Weather Data"},scales:{x:{display:!0,scaleLabel:{display:!0,labelString:"Time (by hour)"}},y:{display:!0,scaleLabel:{display:!0,labelString:"Value"}}}}})}makeChart(data),module.exports=function(e){var e=new Date(e),t=Date.now()-e.getTime(),n=Math.floor(t/36e5),t=Math.floor(t/6e4);return 24<n?e.toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric"}):60<t?n+(1===n?" hr ago":" hrs ago"):t+" mins ago"};
